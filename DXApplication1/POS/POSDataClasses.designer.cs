...
namespace POS
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="IslahPOS")]
	public partial class POSDataClassesDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteVoucherItem(VoucherItem instance);
		...
		public POSDataClassesDataContext() : 
				base(global::POS.Properties.Settings.Default.IslahPOSConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public POSDataClassesDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public POSDataClassesDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public POSDataClassesDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public POSDataClassesDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnContactNoChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Branch_Ledger", Storage="_Ledgers", ThisKey="BranchId", OtherKey="Branch_BranchId")]
    ...
    partial void OnCategoryNameChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_CategoryName", DbType="VarChar(30) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Category_Product", Storage="_Products", ThisKey="CategoryName", OtherKey="Category_CategoryName")]
		public EntitySet<Product> Products
		{
			get
			{
    ...
    partial void OnBranch_BranchIdChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Paid", DbType="Money NOT NULL")]
		public decimal Paid
		{
			get
			{
	...
	public partial class Ledger : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.DateTime _LedgerDate;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnLedgerIdChanging(int value);
    partial void OnLedgerIdChanged();
    partial void OnLedgerDateChanging(System.DateTime value);
    partial void OnLedgerDateChanged();
    partial void OnLeftOverChanging(decimal value);
    partial void OnLeftOverChanged();
    partial void OnTakenChanging(decimal value);
    ...
    partial void OnBranch_BranchIdChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_LedgerId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int LedgerId
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_LedgerDate", DbType="DateTime NOT NULL")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_LeftOver", DbType="Money NOT NULL")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Taken", DbType="Money NOT NULL")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_GivenBy", DbType="VarChar(100) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_TakenBy", DbType="VarChar(100) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Branch_Ledger", Storage="_Branch", ThisKey="Branch_BranchId", OtherKey="BranchId", IsForeignKey=true)]
		public Branch Branch
		{
			get
			{
    ...
    partial void OnBranch_BranchIdChanging(int value);
    partial void OnBranch_BranchIdChanged();
    partial void OnCategory_CategoryNameChanging(string value);
    partial void OnCategory_CategoryNameChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Category_CategoryName", DbType="VarChar(30) NOT NULL", CanBeNull=false)]
		public string Category_CategoryName
		{
			get
			{
				return this._Category_CategoryName;
			}
			set
			{
				if ((this._Category_CategoryName != value))
				{
					if (this._Category.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnCategory_CategoryNameChanging(value);
					this.SendPropertyChanging();
					this._Category_CategoryName = value;
					this.SendPropertyChanged("Category_CategoryName");
					this.OnCategory_CategoryNameChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Category_Product", Storage="_Category", ThisKey="Category_CategoryName", OtherKey="CategoryName", IsForeignKey=true)]
		public Category Category
		{
			...
			set
			{
							...
							|| (this._Category.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						value.Products.Add(this);
						this._Category_CategoryName = value.CategoryName;
					}
					else
					{
						this._Category_CategoryName = default(string);
					}
